...
:uri-igorsilcar: {uri-github}/igorsilcar
:uri-felipefonseca: {uri-github}/felipe-est
...
. {uri-felipefonseca}[Felipe Fonseca]
. {uri-igorsilcar}[Igor Carvalho]
...
* link:aula-05.20160617/index{outfilesuffix}[Aula 17 (17/06/2016)]
